    ...
    <main class="contenedor seccion">
        <div class="capturas">
            <div class="tarjeta">
                ...
                <h3>ACTORES</h3>
                <ul>
                    <li><i class="fas fa-plus-circle"></i><a href="../controlador/consultasControlador.php?metodo=a"> Entregables</a></li>
                    <li><i class="fas fa-plus-circle"></i> <a href="captura_pro_mont2.php">Unidad
                            Requirente</a></li>
            ...
            <div class="tarjeta">
                ...
                <h3>CALENDARIO</h3>
                <ul>
                    <li><i class="fas fa-plus-circle"></i> <a href="../modelo/consulta_vigencia.php"> Fin VIgencia</a></li>
            ...
            <div class="tarjeta">
                ...
                <ul>
                    ...
                    <li><i class="fas fa-plus-circle"></i> <a href="../modelo/consulta_top.php"> Top por Contrato</a></li>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="tab-04">
                                            ...
                                            <input type="text" id="clave2" class="form-control">
                                            <label class="control-label">Presupuesto:</label>
                                           
                                            <input type="text" id="presupuesto2" class="form-control">

                                            <button class="btn btn-default btn-success" type="button" name="submit"
                                                onclick="modificar();">Enviar</button>
                                        </div>
