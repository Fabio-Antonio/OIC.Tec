...
<script   lenguaje="javascript" type="text/javascript" src="js/funciones_proveedor.js">

</script>


<main class="main-captura-pro-montt">

<div class="contendedor-gris-captura-pro-montt">

  <div class="contenedro-proveedor-adjudicado-captura-pro-montt">
    <h1> PROVEEDOR ADJUDICADO </h1>
  
  <div class="nombre-proveedor-adjudicado-captura-pro-montt">
	 <form   id="con_mon"  method="POST">

      <label> Nombre:  </label>
      <input name="nombre" id="noo" placeholder="Nombre" type="text" reduired pattern="[A-Za-zZñÑáéíóúÁÉÍÓÚ\.\s]*">
  </div>

  <div class="rfc-proveedor-adjudicado-captura-pro-montt">
    <label> RFC:  </label>
    <input name="rfc" id="rfc" placeholder="RFC" type="text" required maxlength="13" minlength="13" pattern="[A-Z0-9]*">
  </div>

  <div class="botones-proveedor-adjudicado-captura-pro-montt">
      <button  id="btg" onclick="ingresar();" class="btn btn-verde" type="button"> Guardar </button>
      <button type="button" id="bregresar" class="btn btn-verde"  onclick="location.href='principal2.php'" name="bregresar"> Regresar </button>
    </form>
    </div>
