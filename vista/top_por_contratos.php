...
<body>
    ...
    <main class="main-top-por-contratos">
        <div class="contenedor-gris-top-por-contratos">

            <div class="contenedor-top-por-contratos-tp">

                <h1> TOP MONTOS POR CONTRATOS </h1>

                <div class="tabla-contratos-mas-altos-top-por-contratos">
                    ...
                    $(document).ready(function() {
                        ...
                        var table = $('#myTable').dataTable({
                            ...
                            "bProcessing": true,
                            "sAjaxSource": "../controlador/controlador_tablas.php?metodo=g",
                            "bPaginate": true,
                ...
                <div class="grafica-barra-top-por-contrato">
                    <div id="chartContainer" class="grafica-barras">
                    </div>
                </div>

                <script src="https://canvasjs.com/assets/script/canvasjs.min.js"></script>

                <div class="botones-top-por-contratos">
