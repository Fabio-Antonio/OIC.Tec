...
<main class="main-consulta-por-vigencia">
        <div class="contenedor-gris-consulta-por-vigencia">
            ...
            <div class="semaforo-consulta-por-vigencia">
                <button type="button" name="buttond" onclick="window.location.href='consulta_vigencia_verde.php'"
                    class="botond">6 MESES</button>
                <button type="button" onclick="window.location.href='consulta_vigencia_ama.php'" name="buttont"
                    class="botont">3 MESES</button>
                <button type="button" name="buttonv" onclick="window.location.href='consulta_vigencia_rojo.php'"
                    class="botonv">VENCIDO</button>
                <button type="button" name="buttonto" onclick="window.location.href='consulta_vigencia.php'"
